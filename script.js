...
// fill game grid array with cell object cover entire canvas
function createGrid() {
...
createGrid();
// cycling through array drawing each individual cell
...
class Projectile {
    ...
    draw() {
        ...
        ctx.fill();
        ctx.drawImage(projectile, 0, 0, this.spriteWidth, this.spriteHeight, this.x, this.y, this.width, this.height);
...
class Resource {
    constructor() {
        ...
        this.spriteWidth = 792;
        this.spriteHeight = 804;
    }
    draw() {
...
canvas.addEventListener('click', function() {
    ...
    if (numberOfResources >= defenderCost) {
        ...
        floatingMessages.push(new floatingMessage('need more resources', mouse.x, mouse.y, 20, 'yellow'))
    }
});
...
function animate() {
    ...
    ctx.fillStyle = 'Grey';
    ctx.drawImage(bkGround, 0, 0, 900, 600);
